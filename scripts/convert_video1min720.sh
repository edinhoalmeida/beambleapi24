...
ffmpeg -y -i ${FILE} -ss 00:00:00.000 -to 00:03:00.000 -vf scale=720:1280 -c:v libx264 -b:v 4M -maxrate 4M -bufsize 8M -preset fast -profile:v high -level 4.1 -c:a aac -b:a 128k -movflags +faststart -f mp4 ${FILE2}        
